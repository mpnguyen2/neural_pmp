...
def train_env(env_name, stochastic=False, device=device_default, num_episodes=20, rate=1.5, batch_size=32, num_hnet_train_max=10000, num_adjoint_train_max=1000, 
    ...
    training(stochastic, device, env, env_name, num_episodes,
...
if __name__ == '__main__':
    ...
    train_env(env_name=args.env_name, stochastic=args.stochastic, device=args.device, num_episodes=args.num_episodes, rate=args.rate, 
        batch_size=args.batch_size, num_hnet_train_max=args.num_hnet_train_max, num_adjoint_train_max=args.num_adjoint_train_max,
