...
train_mt, train_pendulum, train_cart = False, False, True
...
if train_mt:
    ...
    train_phase_1(env, adj_net, h_net, qs=q_samples, 
                  ...
                  batch_size=10, num_epoch=20, lr = 1e-4, 
                  log_interval=200, model_name='mountain_car')
...
if train_pendulum:
    ...
    train_phase_1(env, adj_net, h_net, qs=q_samples, 
                  dynamic_hidden=False, alpha=1,
                  batch_size=10, num_epoch=20, lr = 1e-4, 
                  log_interval=200, model_name='pendulum')
...
if train_cart:
    ...
    train_phase_1(env, adj_net, h_net, qs=q_samples, 
                  dynamic_hidden=False, alpha=1,
                  batch_size=10, num_epoch=20, lr = 1e-4, 
                  log_interval=200, model_name='cartpole')
